...
- [ ] 4a: Create Python SDK in `sdks/python/` (using httpx, async support)
- [ ] 4b: Create Go SDK in `sdks/go/` (using net/http)
- [ ] 4c: Create TypeScript SDK in `sdks/typescript/` (using fetch, typed responses)

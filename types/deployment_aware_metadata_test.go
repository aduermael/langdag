...
func TestNormalizedUsagePreservesLegacyAndExtensibleDimensions(t *testing.T) {
	...
	for _, name := range []string{"output_tokens", "cache_read_input_tokens", "cache_creation_input_tokens", "reasoning_tokens", "tool_use_prompt_tokens", "image_input_tokens"} {
